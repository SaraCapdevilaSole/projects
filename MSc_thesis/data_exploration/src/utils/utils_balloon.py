from src.config.config_balloon import HEMI, DATA_PATH, wave_model, no_ODE_y
...
class Balloon:
    def __init__(self, t_array, data_path=os.path.join(DATA_PATH, wave_model), data=None):
        ...
        self.data = self._load_data() if data is None else self._format_data(data)
    ...
    def _load_file(data_path):
        # NOTE: I've added 2.2 to meshio/vtu/_vtu file: if version not in ["0.1", "1.0", "2.2"]
