    ...
    parameters_dict = {
        ...
        "arch_reparam": {
            "values": [
                ...
                {"type": "weight_fact", "mean": 0.5, "stddev": 1},
                {"type": "weight_fact", "mean": 1.0, "stddev": 1},
            ]
        },
        "fourier_emb": {"values": [
        ...
        "init_weights": {"values": [
            {"ics": 1.0, "data": 1.0, "res": 100.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 1.0, "res": 1000.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 10.0, "res": 1.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 100.0, "res": 1.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 1000.0, "res": 1.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 10.0, "res": 10.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 10.0, "res": 100.0, "H": 1.0, "n": 1.0},
            {"ics": 1.0, "data": 100.0, "res": 10.0, "H": 1.0, "n": 1.0},
        ]},
    }
