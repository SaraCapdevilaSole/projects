...
def get_config():
    ...
    config_data.T = 0.1 # use T seconds 
    ...
    config_data.ncurv_path = 'unit_sphere' #'/vol/bitbucket/sc3719/firedrake_simulation/data/input_data/inflated_mesh_curvature_normals/norm_curv_164k/norm_curv_164_jm.npy'
