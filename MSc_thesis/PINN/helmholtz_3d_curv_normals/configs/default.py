...
def get_config():
    ...
    wandb.name = 'helm_subset_jm_ic=Q_dt=1e-6_T=0.01_emb50_nondim_repeated_surfaceloss_emb10' # TODO: change input dim
    ...
    if config_data.radius == 100:
        ...
        config_data.r = 30 
        mult = (100,100) # except if real mesh!
        v = 100
        normalise = False
    else:
    ...
    config_data.ncurv_path = '/vol/bitbucket/sc3719/firedrake_simulation/data/input_data/inflated_mesh_curvature_normals/norm_curv_164k/norm_curv_164_jm.npy'
