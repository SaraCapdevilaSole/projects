...
def get_config():
    ...
    wandb.name = "rs_and_Q0_prediction_5s"
    wandb.tag = None
    ...
    config_data.T = 6 #0.1 # use T seconds 
    ...
    config_data.model_terms = {
        ...
        'terms': {
            'Qs': False, # determines spatial part of noise only
            'max_f': False,
            'min_f': False,
            'step_f': False,
            'mult_f': False,
            ...
            'noise': True, # dont set both Qs and Qs_params
            'rs': True,
            'gamma': False,
            'grad': False,
            'tgrad': False,
