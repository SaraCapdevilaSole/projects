...
def get_config():
    """Returns the default configuration for the Helmholtz 3D model training."""
    ...
    wandb.name = "helm_subset_jm_ic=Q_dt=1e-6_T=0.01_emb50_nondim_repeated"
    wandb.tag = None
    ...
    config_data.save_eval_dir = "/vol/bitbucket/sc3719/firedrake_simulation/data/output_pinn_inflated"
